...
async function addUser(user: UserDetails): Promise<void> {
    const respone = await fetch('http://localhost:5041/api/userdetails', {
        method: 'POST',
        headers: {
...
async function addBook(book: BookDetails): Promise<void> {
    const respone = await fetch('http://localhost:5041/api/bookdetails', {
        method: 'POST',
        headers: {
            'content-type': 'application/json'
        },
...
async function addBorrow(borrow: BorrowDetails): Promise<void> {
    const respone = await fetch('http://localhost:5041/api/borrowdetails', {
        method: 'POST',
        headers: {
            'content-type': 'application/json'
        },
...
async function updateBook(id: number, book: BookDetails): Promise<void> {
    const response = await fetch(`http://localhost:5041/api/bookdetails/${id}`, {
        method: 'PUT',
        headers: {
            'content-type': 'application/json'
        },
...
async function updateBorrow(id: number, borrow: BorrowDetails): Promise<void> {
    const response = await fetch(`http://localhost:5041/api/borrowdetails/${id}`, {
        method: 'PUT',
        headers: {
            'content-type': 'application/json'
        },
