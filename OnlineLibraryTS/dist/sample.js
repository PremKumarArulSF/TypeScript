                ...
                if (bookList.bookCount >= Number(bookCount.value)) {
                    borrows.forEach(list => {
                        if (list.userID == currentUser.userID) {
                            if (list.borrowBookCount == 3) {
                                alert("You have borrowed 3 books already");
                                flag = false;
                            }
                            else if (Number(bookCount.value) > 3 && list.borrowBookCount > 3) {
                                alert(`You can have maximum of 3 borrowed books.Your already borrowed books count is ${list.borrowBookCount} and requested Count ${bookCount.value}, which exceed 3`);
                                flag = false;
                            }
                        }
                    });
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        borrows.forEach(list => {
            ...
            row.innerHTML = `
               ...
               <td>${list.borrowBookCount}</td>
               <td>${list.status}</td>
               <td>${list.paidFineAmount}</td>
                  `;
                ...
                borrows.forEach(list => {
                    if (list.borrowID == userBorrowID) {
                        let borrowUpdate = {
                            ...
                            borrowBookCount: list.borrowBookCount,
                            status: "Returned",
                        ...
                        currentBook.bookCount += list.borrowBookCount;
...
function addUser(user) {
    return __awaiter(this, void 0, void 0, function* () {
        const respone = yield fetch('http://localhost:5041/api/userdetails', {
            method: 'POST',
            headers: {
...
function addBook(book) {
    return __awaiter(this, void 0, void 0, function* () {
        const respone = yield fetch('http://localhost:5041/api/bookdetails', {
            method: 'POST',
            headers: {
                'content-type': 'application/json'
            },
...
function addBorrow(borrow) {
    return __awaiter(this, void 0, void 0, function* () {
        const respone = yield fetch('http://localhost:5041/api/borrowdetails', {
            method: 'POST',
            headers: {
                'content-type': 'application/json'
            },
...
function fetchBook() {
    return __awaiter(this, void 0, void 0, function* () {
        const apiURL = `http://localhost:5041/api/bookdetails`;
        const response = yield fetch(apiURL);
        if (!response.ok) {
...
function fetchBorrow() {
    return __awaiter(this, void 0, void 0, function* () {
        const apiURL = `http://localhost:5041/api/borrowdetails`;
        const response = yield fetch(apiURL);
        if (!response.ok) {
...
function updateBook(id, book) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`http://localhost:5041/api/bookdetails/${id}`, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json'
            },
...
function updateBorrow(id, borrow) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`http://localhost:5041/api/borrowdetails/${id}`, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json'
            },
